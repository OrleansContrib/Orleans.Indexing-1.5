...
namespace UnitTests.IndexingTests
{
    ...
    public class ChainedBucketIndexingTestsTwoSilos : HostedTestClusterEnsureDefaultStarted
    {

        private readonly ITestOutputHelper output;

        public ChainedBucketIndexingTestsTwoSilos(DefaultClusterFixture fixture, ITestOutputHelper output)
            : base(fixture)
        {
            this.output = output;
        }
